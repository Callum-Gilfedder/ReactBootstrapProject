...
export default function OffCanvas(props) {
    ...
    return (
        ...
        {count5 ? <><OffCanvasItem setCount={setCount5} count={count5} title="The Catcher In The Rye" author="J. D. Salinger" type="Hardback & Paperback" oldPrice = "£10.00" newPrice ="£8.00" image={book5}/>     <hr></hr></> : null}
        {count6 ? <><OffCanvasItem setCount={setCount6} count={count6} title="A Clockwork Orange" author="Anthony Burgess" type="Hardback Only" oldPrice = "8.00" newPrice ="£4.50" image={book6}/>     <hr></hr></> : null}
